...
public enum Asset {
  public enum Colors {
    public static let iconPrimary = ColorAsset(name: "icon-primary")
    public static let iconSecondary = ColorAsset(name: "icon-secondary")
    public static let iconTertiary = ColorAsset(name: "icon-tertiary")
    public static let overPrimary = ColorAsset(name: "overPrimary")
    public static let overSecondary = ColorAsset(name: "overSecondary")
    ...
    public static let textTertiary = ColorAsset(name: "text-tertiary")
